		...
		private void saveROMAsToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			if (result == DialogResult.OK) // Test result.
			{
				if (saveFileDialog1.FilterIndex == 1)
					ROM.Instance.saveFileAs(saveFileDialog1.FileName, RomEndian.Big);
				else if (saveFileDialog1.FilterIndex == 2)
					ROM.Instance.saveFileAs(saveFileDialog1.FileName, RomEndian.Mixed);
				else if (saveFileDialog1.FilterIndex == 3)
					ROM.Instance.saveFileAs(saveFileDialog1.FileName, RomEndian.Little);
			}
		}
